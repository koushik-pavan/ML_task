...
plot_confusion_matrix(estimator=m,X=val_x,y_true=val_y)

std_score=m.score(val_x,val_y)
std_score
...
for i in heart_features:
  ...
  print(val_temp.head())
  print(m.score(val_temp,val_y))
  feat_imp[i]=std_score-m.score(val_temp,val_y)

feat_imp.head()

# i found that the 3 most important features are thalachh, exng and oldpeak because they created most variation in the prediction when changed .it was consistent among many trials which i did to train the model
